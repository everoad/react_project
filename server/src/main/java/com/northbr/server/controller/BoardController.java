...
public class BoardController {
  ...
  @PutMapping("/board")
  public ProcessResult editBoardItem(@RequestBody BoardVo boardVo) throws Exception {
    return boardService.editBoardItem(boardVo);
  }

  @DeleteMapping("/board")
  public ProcessResult removeBoardItem(@RequestBody BoardVo boardVo) throws Exception {
    return boardService.removeBoardItem(boardVo);
  }
}